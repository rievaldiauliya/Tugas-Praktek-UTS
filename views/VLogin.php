...
<div class="login-box">
  <div class="login-logo">
    <a href="temp/index2.html"><b>PDBI</b>KINGDOM</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
   ...
   <form action="" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <input type="submit" name="btn_login" value="Login" class="btn btn-primary btn-block btn-flat">
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- iCheck -->
<script href="<?php echo base_url('temp/plugins/iCheck/icheck.min.js'); ?>"></script>
<script>
  $(function () {
    $('input').iCheck({
